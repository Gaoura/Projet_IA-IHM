                                                        ...
                                                        const string & couleur)
{
    ...
    for ( l = graphe.lSommets; l; l = l->s)
    {
        ...
        of << "point remarquable = " << rayonSommet << " "
            << couleur << " "
            << info->position << " "
            << info->nom << info->position << endl;
    }
}

/*static*/ void DessinGrapheRecuitSimule::ecritAretes(ofstream & of,
                                                        const Graphe<InfoAreteCarte,
                                                        InfoSommetCarte> & graphe,
                                                        const string & couleur)
{
                                            ...
                                            const string & couleurAretes)
{
    ...
    DessinGraphe::ecrireEntete( of, "carte routière",
                                "carte routière simplifiée représentée par un graphe",
                                resume, coinBG, coinHD);
